...
# from learners.autoregressive_learner import AutoregressiveLearner
...
learner.construct_models(model_cls=PixelCNN, model_opt=model_opt, learning_rate=args.learning_rate, trainable_params=None, eval_keys=['total loss', 'nll loss', 'bits per dim'])
