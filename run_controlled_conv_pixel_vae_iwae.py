...
with tf.Session(config=config) as sess:
    ...
    if args.mode == 'train':
        ...
        if 'mnist' in args.data_set:
            ...
            learner.preload(from_dir="/data/ziz/jxu/save_dirs/model_church_outdoor_controlled_pixel_vae_mmd_{0}_{1}".format(args.phase, mtype), var_list=None)
        else:
            learner.preload(from_dir="/data/ziz/jxu/save_dirs/model_celeba_controlled_pixel_vae_mmd_{0}_{1}".format(args.phase, mtype), var_list=None)
